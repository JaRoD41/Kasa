...
export default function Carrousel( {
  ...
  const [current,
  setCurrent]=useState(0) //je définis l'index du premier slide à 0
  ...
  return (<section id='carrousel-container'> {
      length > 1 && (<img src= {
          left
        }
